...
`,
		...
		},
		{
			...
			// backoffice (Warn с err + возврат чистого состояния курсора).
...
`,
		...
		},
		{
			...
			// но потерей ошибку не назвать. Репро: newAlertNotifier backoffice
...
`,
		...
		},
		{
			...
			// отличит сбой от честного нуля (исходный saga-кейс остаётся красным).
