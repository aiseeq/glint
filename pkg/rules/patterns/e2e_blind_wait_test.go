...
// Репро из projectA: четыре админских спека падали по таймауту networkidle или читали
...
// Мягкая синхронизация с запасным путём (хелпер forDataSync в projectA) — не единственное
