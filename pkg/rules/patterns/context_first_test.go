...
// Repro from projectA: a scheduler started here and stopped elsewhere keeps its own
...
// Repro from projectA: graceful shutdown in package main builds its own timeout
